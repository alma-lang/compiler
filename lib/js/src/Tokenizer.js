    ...
    if (typeof tokenType === "number") {
      ...
      switch (tokenType.TAG | 0) {
        ...
        case /* NumberToken */1 :
            ...
            if (c === ".") {
              if (tokenType._0) {
                return addError(state, undefined, "Multiple dots while parsing a number.");
              } else {
                state.status = {
                  TAG: 1,
                  _0: true,
            ...
            var c$1 = peek(state);
            if (c$1 !== undefined && (c$1 === "." || isDigit(c$1))) {
              return ;
            } else {
        ...
        case /* IdentifierToken */2 :
            ...
            if (!isIdentifierChar(c$2, tokenType._0)) {
            ...
            var c$3 = peek(state);
            if (c$3 !== undefined && isIdentifierChar(c$3, false)) {
              return ;
            }
...
exports.identifierStartRe = identifierStartRe;
exports.identifierRestRe = identifierRestRe;

...
function linesBeforePosition(input, _position, _howManyLines, lines) {
  while(true) {
...
function linesAfterPosition(input, _position, _howManyLines, lines) {
  while(true) {
    var howManyLines = _howManyLines;
    var position = _position;
    var match = lineAt(input, position);
...
function linesReportAtPositionWithPointer(input, position, lineNumber, columnNumber) {
  return Belt_Option.flatMap(linesAroundPosition(input, position, 2), (function (param) {
                ...
                console.log(linesBefore, line, linesAfter);
                var out = [];
...
exports.lineSubstring = lineSubstring;
exports.lineAt = lineAt;
exports.linesBeforePosition = linesBeforePosition;
exports.linesAfterPosition = linesAfterPosition;
exports.linesAroundPosition = linesAroundPosition;
exports.linesReportAtPositionWithPointer = linesReportAtPositionWithPointer;
/* No side effect */

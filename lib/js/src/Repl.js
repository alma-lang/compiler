...
function run(param) {
  ...
  var loop = function (param) {
    return Readline.question(readline, "> ", (function (input) {
                  ...
                  if (errors.TAG !== /* Ok */0) {
                    return Belt_Array.forEach(errors._0, (function (prim) {
                                  console.log(prim);
                  ...
                  if (errors$1.TAG !== /* Ok */0) {
                    return Belt_Array.forEach(errors$1._0, (function (prim) {
                                  console.log(prim);
                                  
                                }));
                  }
                  try {
                    Type.print(Infer.infer(errors$1._0, TypeEnv.empty(undefined)));
                  }
                  catch (raw_exn){

...
function toString$1(expr) {
  ...
  switch (expr.TAG | 0) {
    ...
    case /* FnCall */7 :
        var argsStr = Belt_Array.map(expr._1, (function (a) {
                  return toString$1(a.value);
                })).join(", ");
        return toString$1(expr._0.value) + "(" + argsStr + ")";
    case /* Let */8 :
        return "let " + expr._0.value._0 + " = (" + toString$1(expr._1.value) + "); " + toString$1(expr._2.value);
    case /* If */9 :
        return "(" + toString$1(expr._0.value) + " ? " + toString$1(expr._1.value) + " : " + toString$1(expr._2.value) + ")";

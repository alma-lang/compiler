...
function addError(state, useStartOpt, message) {
  ...
  var column = match[1];
  var message$1 = String(state.line) + ":" + String(column) + "\n" + message + "\n" + Belt_Option.getWithDefault(Input.linesReportAtPositionWithPointer(match[0], state.line, undefined, state.input), "");
  state.errors.push({
        line: state.line,
        column: column,
        message: message$1
    ...
    if (typeof tokenType === "number") {
      if (tokenType === /* SingleToken */0) {
        ...
        switch (ch) {
          ...
          case "!" :
              ...
              if (match === "=") {
                ...
                return addToken(state, /* Bang */13);
              }
          case "\"" :
              state.status = {
                TAG: 2,
                _0: false,
                [Symbol.for("name")]: "StringToken"
              };
              return ;
          case "(" :
          ...
          case "=" :
              ...
              if (match$4 === "=") {
                ...
                return addToken(state, /* Equal */15);
              }
          case ">" :
              var match$5 = peek(state);
              if (match$5 === "=") {
                state.status = {
                  TAG: 0,
                  _0: /* GreaterEqual */18,
                ...
                return addToken(state, /* Greater */17);
              }
          case "\\" :
              return addToken(state, /* Backslash */11);
          case "{" :
        ...
        switch (match$6) {
          case "" :
          case "\n" :
              return addToken(state, /* Comment */38);
          default:
            return ;
        }
      }
      ...
      switch (tokenType.TAG | 0) {
        ...
        case /* StringToken */2 :
            var prevWasBackslash = tokenType._0;
            var match$9 = state.currentChar;
            switch (match$9) {
              case "" :
              ...
              case "\"" :
                  if (prevWasBackslash) {
                    ...
                    return addToken(state, /* String */23);
                  }
              case "\\" :
                  state.status = {
                    TAG: 2,
        ...
        case /* NumberToken */3 :
            ...
            if (c$2 !== undefined && (c$2 === "." || isDigit(c$2))) {
              ...
              return addToken(state, /* Float */24);
            }
        case /* IdentifierToken */4 :

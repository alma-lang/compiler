...
function toString(e, input) {
  ...
  var match$3 = e._0;
  var code = Belt_Option.getWithDefault(Input.linesReportAtPositionWithPointer(input, match$3.start, match$3.line, match$3.column), "");
  var tmp;
  switch (e.TAG | 0) {
    case /* UndefinedIdentifier */0 :
    ...
    case /* TypeMismatch */1 :
        ...
        var typ = e._1;
        if (expr2 !== undefined) {
          var code2 = Belt_Option.getWithDefault(Input.linesReportAtPositionWithPointer(input, expr2.start, expr2.line, expr2.column), "");
  ...
  var inferRec = function (_env, _ast) {
    while(true) {
      ...
      switch (x.TAG | 0) {
        ...
        case /* FnCall */7 :
            var f = x._0;
            var t0 = inferRec(env, f);
            var t1 = inferRec(env, x._1);
            var t$p = newTypeVar(state);
            addError(unify(f, {
                      TAG: 2,
                      _0: t1,
                      _1: t$p,
        ...
        case /* If */9 :
            ...
            var t1$1 = inferRec(env, $$then);
            var t2 = inferRec(env, else_);
            addError(unify($$then, t1$1, else_, t2));
            return t2;

    ...
    while(true) {
      ...
      switch (x.TAG | 0) {
        ...
        case /* FnCall */7 :
            ...
            var argsTypes = Belt_Array.map(x._1, (function(env){
                return function (arg) {
                  return inferRec(env, arg);
                }
                }(env)));
            var returnType$1 = newTypeVar(state);
            var callType = Belt_Array.reduceReverse(argsTypes, returnType$1, (function (returnType, argType) {
                    return {
                            TAG: 2,
                            _0: argType,
                            _1: returnType,
            ...
            addError(unify(ast, callType, undefined, fnType));
            return returnType$1;
        case /* Let */8 :

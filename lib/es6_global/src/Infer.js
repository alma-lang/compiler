    ...
    while(true) {
      ...
      switch (x$1.TAG | 0) {
        ...
        case /* Binary */5 :
            ...
            continue ;
        case /* Lambda */6 :
            var paramsWithType = Belt_Array.map(x$1._0, (function (p) {
                    return [
                            p,
                            newTypeVar(state)
                          ];
            ...
            var returnType = inferRec(env$1, x$1._1);
        ...
        case /* Let */8 :
            ...
            state_currentLevel.contents = state_currentLevel.contents - 1 | 0;
            var x$2 = x$1._0.value;
            var env$2 = TypeEnv.set(env, x$2._0, generalize(t$1, state));
            _x = x$1._2;
            _env = env$2;
            continue ;
        case /* If */9 :
            var t$2 = inferRec(env, x$1._0);
            unify(t$2, Type.bool_);
            var t1$1 = inferRec(env, x$1._1);
            var t2 = inferRec(env, x$1._2);
            unify(t1$1, t2);
            return t2;

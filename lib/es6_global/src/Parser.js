...
function nestedIndent(parser, parentToken) {
  var token = getToken(parser);
                  ...
                  if (match !== 29) {
                    ...
                    return Belt_Result.flatMap(expression(advance(parser)), (function ($$then) {
                                  ...
                                  if (match !== 30) {
                                    ...
                                    return Belt_Result.flatMap(expression(advance(parser)), (function (else_) {
                                                  return {
                                                          TAG: 0,
                                                          _0: {
                                                            value: {
  ...
  if (match !== 11) {
    ...
    return Belt_Result.flatMap(params(advance(parser)), (function (params) {
                  ...
                  if (match !== 21) {
                    ...
                    return Belt_Result.flatMap(expression(advance(parser)), (function (expr) {
                                  return {
                                          TAG: 0,
                                          _0: {
                                            value: {
...
function call(parser) {
  ...
  return Belt_Result.flatMap(primary(parser), (function (expr) {
                if (expr !== undefined) {
                  return callStep(parser, token, expr);
                } else {
                  return {
                          TAG: 1,
...
function callStep(parser, firstToken, returnExpr) {
  if (nestedIndent(parser, firstToken)) {
    return Belt_Result.flatMap(primary(parser), (function (arg) {
                  if (arg !== undefined) {
                    return callStep(parser, firstToken, {
                                value: {
                                  TAG: 7,
                                  _0: returnExpr,
                                  _1: arg,
...
function primary(parser) {
  ...
  if (match !== 0) {
    ...
    result = Belt_Result.flatMap(expression(advance(parser)), (function (expr) {
